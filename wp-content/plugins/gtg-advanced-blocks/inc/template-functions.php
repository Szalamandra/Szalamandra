...
if ( ! function_exists( 'gtg_block_add_body_class' ) ) {
	function gtg_block_add_body_class($classes) {
		...
		if ( is_rtl() ) {
			$classes[] = 'gutengeek-is-rtl';
		}
		return $classes;
	}
}

if ( ! function_exists( 'gtg_get_template_part' ) ) {
	/**
	...
	function gtg_get_template_part( $slug, $name = '' ) {
		...
		if ( !$template ) {
			if ( $name ) {
				...
				if ( !$template ) {
					$fallback = gtg_advanced_blocks()->plugin_path() . "/templates/{$slug}-{$name}.php";
...
if ( ! function_exists( 'gtg_get_template' ) ) {
	/**
...
if ( ! function_exists( 'gtg_get_template_html' ) ) {
	/**
...
if ( ! function_exists( 'gtg_locate_template' ) ) {
	/**
	...
	function gtg_locate_template( $template_name, $template_path = '', $default_path = '' ) {
		...
		if ( !$default_path ) {
			$default_path = gtg_advanced_blocks()->plugin_path() . '/templates/';
		}
