...
class Block_Factory {
	...
	public function __construct() {
		...
		// WooCommerce Support custom attributes
		add_filter( 'register_block_type_args', [ $this, 'woocommerce_custom_attributes' ], 10, 2 );
	}
	...
	/**
	 * default custom block attributes
	 *
	...
	public function custom_attributes() {
		...
		return apply_filters( 'gutengeek_custom_block_attributes', $attributes );
	}
	 ...
	 * @since 1.0.6
	 */
	public function woocommerce_custom_attributes( $args, $name ) {
		if ( strpos( $name, 'woocommerce/' ) !== false && isset( $args['attributes'] ) ) {
			$args['attributes'] = array_merge( $args['attributes'], $this->custom_attributes() );
		}
