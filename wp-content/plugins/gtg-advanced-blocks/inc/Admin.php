...
if ( !class_exists( 'Admin' ) ) {
	...
	final class Admin {
		...
		public static function init() {
			...
			// Add a post display state for special pages imported.
		...
		public static function activation_redirect() {
			if ( get_option( '_gutengeek_do_redirect' ) && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) ) {
		...
		public static function add_display_post_states( $post_states, $post ) {
			if ( $post && metadata_exists( 'post', $post->ID, '_gutengeek_kit_name_imported' ) ) {
				$post_states['gutengeek_kit_name_imported'] = get_post_meta( $post->ID, '_gutengeek_kit_name_imported', true );
			}
			return $post_states;
		}
	}
